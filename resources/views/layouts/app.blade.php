                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="messages">Messages <sup style="display: none;" id="supNewMessages"><span class="badge badge-pill badge-primary" id="newMessages"></span></sup><span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
...
<script>
    $( document ).ready(function() {
        ...
        // vsake 3s preveri, če so nova sporočila
        window.setInterval(getNumberOfNewMessages, 3000);
    });
</script>